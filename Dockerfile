...
# tidymodels, readr, ggplot2 are innately provided
...
# RUN Rscript -e "remotes::install_version('readr', version='2.1.5', repos='https://cloud.r-project.org')" # already provided in jupyter/r-notebook
